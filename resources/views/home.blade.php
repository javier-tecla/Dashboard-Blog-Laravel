...
@section('content')
    <div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
        ...
        <img src="{{ asset('dev.png') }}" class="absolute -right-20 -bottom-20 opacity-20">
    </div>
        ...
        <div class="grid grid-cols-1 gap-4 mb-4">       
            ...
            <a href="" class="bg-gray-100 rounded-lg px-6 py-4">
                <p class="text-xs flex items-center gap-2">
                    <span class="uppercase text-gray-700 bg-gray-200 rounded-full px-2 py-1">Turorial</span>
                    <span>{{ $post->created_at->format('d/m/t') }}</span>
                </p>
